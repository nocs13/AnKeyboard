...
public class kAnKeyboard extends Activity implements OnTouchListener, OnClickListener, OnFocusChangeListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            setContentView(new kAnKeyboardView(getApplication()));
